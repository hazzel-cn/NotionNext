...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'hazzel', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Always a noob hacker', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.hazzel.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Blog, Security, Security Research', // 网站关键词 英文逗号隔开
